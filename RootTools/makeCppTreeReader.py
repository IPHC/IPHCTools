...
##################################################################
#                                                                #
# This script automatically generate a C++ interface             #
# to read a given flat-tree format. To do that, the              #
# script opens an example of root file you want to               #
# interface with, and loop on the branches to get their          #
# names and types.                                               #
#                                                                #
# Usage :                                                        #
#  ./thisScript.py file.root treeName                            #
#                                                                #
# Known issue :                                                  #
#  - Fixed-size array are not handled properly at the moment.    #
#    You might need to add the size yourself afterwards, i.e.    #
#    int someBranch;    -----> int someBranch[6];                #
#                                                                #
##################################################################
